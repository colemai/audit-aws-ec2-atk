...
coreoExport('violations', violations.violations);
callback(notifiers);
  EOH
end
...
#    action :set
#    variables([
#                  {'COMPOSITE::coreo_aws_rule_runner_ec2.advise-ec2-atk.report' => 'COMPOSITE::coreo_uni_util_jsrunner.tags-to-notifiers-array-ec2-atk.return.violations'}
#              ])
#  end
